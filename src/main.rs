...
fn play<G: Guesser>(answer: &str, guesser: G) {
    todo!();
}
...
mod tests {
    mod compute_correctness {
        ...
        #[test]
        fn all_right() {
            assert_eq!(Correctness::compute("aaaaa", "aaaaa"), mask![C C C C C]);
        }
        ...
        #[test]
        fn all_wrong() {
            assert_eq!(Correctness::compute("aaaaa", "bbbbb"), mask![W W W W W]);
        }
